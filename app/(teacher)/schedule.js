...
export default function Schedule() {
  ...
  // Обработка данных расписания для преподавателей
  const processSchedule = (data) => {
    ...
    data.forEach((lesson) => {
      ...
      const isTeacherLesson = lesson.teacher_name === user.teacher;
      ...
      if (isTeacherLesson) {
        ...
        // Проверяем, существует ли урок для этого предмета и типа
        ...
        if (existingLesson) {
          // Если существует, добавляем группу к существующему занятию
          ...
          // Если не существует, добавляем новый урок с массивом групп
...
const styles = StyleSheet.create({
  ...
  groupsText: {
    fontSize: 15,
    color: '#FF9500',  // Использую оранжевый цвет для групп у преподавателя
    fontWeight: '500',
  },
  emptyContainer: {
    flex: 1,
